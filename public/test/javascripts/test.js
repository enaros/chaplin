...
window.require.register("test/views/about-view-test", function(exports, require, module) {
  var AboutView;
...
window.require.register("test/views/configuration-view-test", function(exports, require, module) {
...
window.require.register("test/views/file-view-test", function(exports, require, module) {
  var FileView;
